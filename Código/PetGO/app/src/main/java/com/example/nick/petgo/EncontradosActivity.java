...
public class EncontradosActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_encontrados);
        ...
        Mascotas.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot nodo: dataSnapshot.getChildren()){
                    ...
                    if(M.getCategoria().equals("Encontrado"))
                        extraviadas.add(M);
                }
